...
export const projectDetails: Record<string, { description: string; stack: string[]; category: string }> = {
  ...
  "sketchbook_": { description: "A single-page art portfolio — a compact gallery for sketches and finished pieces, live at sketchbook.bayue.my.id.", stack: ["TypeScript", "CSS", "HTML"], category: "Web apps" },
